...
const NewDashboard = () => {
  ...
  const [state, setState] = useState({
    value: "https://swiftearnprime.org/",
    copied: false,
  });
    ...
    <Container>
        ...
        <Wrapper2>
          ...
          >
            ...
            <Right>
              <AiOutlineDollar style={{width: 45, height: 45, color: "#fff"}}/>
            </Right>
          </InputHold>
            <InputHold>
            <Left>
            ...
            <Right>
              <AiOutlineWallet style={{width: 45, height: 45, color: "#fff"}}/>
            </Right>
          </InputHold>
            <InputHold>
            <Left>
            ...
            <Right>
              <AiOutlineCodeSandbox style={{width: 45, height: 45, color: "#fff"}}/>
            </Right>
          </InputHold>
            <InputHold>
            <Left>
            ...
            <Right>
              <AiOutlineCreditCard style={{width: 45, height: 45, color: "#fff"}}/>
            </Right>
          </InputHold>
            <InputHold>
            <Left>
            ...
            <Right>
              <AiOutlineCloud style={{width: 45, height: 45, color: "#fff"}}/>
            </Right>
          </InputHold>
            <InputHold>
            <Left>
            ...
            <Right>
              <AiFillProfile style={{width: 45, height: 45, color: "#fff"}}/>
            </Right>
          </InputHold>
            </Hold>
            <LeftHold>
