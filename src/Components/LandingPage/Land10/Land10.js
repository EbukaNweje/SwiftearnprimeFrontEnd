  ...
  return (
    <Container>
        ...
        <Wrapper>
            ...
            <Line></Line>
            <Div3>
                <H1 data-aos="fade-down" style={{color: "#D77600"}}>Investment plans that suits your personality</H1>
                ...
                <Box data-aos="fade-down">
                    <FaMoneyBill style={{color: "#fff", width: "30px", height: "30px"}}/>
                    <Butn>Forex</Butn>
                </Box>
                <Box data-aos="fade-down">
                <FaChartBar style={{color: "#fff", width: "30px", height: "30px"}}/>
                    <Butn>Stocks</Butn>
                </Box>
                <Box data-aos="fade-down">
                <FaCoins style={{color: "#fff", width: "30px", height: "30px"}}/>
                    <Butn>Crypto</Butn>
                </Box>
                <Box data-aos="fade-down">
                <FaMoneyBill style={{color: "#fff", width: "30px", height: "30px"}}/>
