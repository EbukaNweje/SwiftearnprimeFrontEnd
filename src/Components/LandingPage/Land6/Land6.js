    ...
    <Container>
        ...
        <BoxHold>
            <Box data-aos="fade-down">
                <GiHandOk style={{width: 50, height: 50, color: "#fff"}}/>
                <h6>Fast & easy h6rocess</h6>
                <p>Easy to invest and trade</p>
            </Box>
            <Box data-aos="fade-down">
                <FaFileSignature style={{width: 50, height: 50, color: "#fff"}}/>
        ...
        <BoxHold>
            <Box data-aos="fade-down">
                <FaScroll style={{width: 50, height: 50, color: "#fff"}}/>
                <h6>Control over Policy</h6>
                <p>Our policy apply when trading</p>
            </Box>
            <Box data-aos="fade-down">
                <GiCash style={{width: 50, height: 50, color: "#fff"}}/>
