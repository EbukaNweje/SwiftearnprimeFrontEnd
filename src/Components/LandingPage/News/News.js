      ...
      <H1>News and Analysis</H1>
        ...
        <Right>
          ...
          <Two>
            ...
            <p style={{width: "90%", color:"#D77600"}}>Investing in stocks can be a great way to grow your wealth over the long term</p>
          </Two>
          <Two>
            <AiOutlineArrowRight style={{color:"white"}}/>
            <p style={{width: "90%", color:"#D77600"}}>Stocks, also known as equities, represent a share in ownership of a company.When you buy a stock, you're essentially buying a piece of the company.</p>
          </Two>
        ...
        <Latest>
          ...
          <Two>
            <AiOutlineArrowRight style={{color:"white"}}/>
            <p style={{width: "90%", color:"#D77600"}}>With patience, persistence, and a long-term perspective, investing in stocks can be a rewarding experience.</p>
          </Two>
          <Two>
            <AiOutlineArrowRight style={{color:"white"}}/>
            <p style={{width: "90%", color:"#D77600"}}>It's also important to understand that past performance is not a guarantee of future performance</p>
          </Two>
          <Button to='/newsdetailpage'>See Full List</Button>
        </Latest>
        </Right>
