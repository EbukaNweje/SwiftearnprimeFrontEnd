...
const RestPassword = () => {
  ...
  const url = `https://swiftearnprime.onrender.com/api/restLink/${userid}/${tokenid}`
const Data = {password}
console.log(url)
console.log(Data)
      ...
      <Wrapper>
          <Card>
              ...
              <Form onSubmit={(e)=> Login(e)}>
                  ...
                  <PassWordText><span style={{color: "#D77600", cursor: "pointer", textDecoration: "underline"}}>Forgot your password?</span></PassWordText>
              </Form>
          </Card>
      </Wrapper>
  </Container>
