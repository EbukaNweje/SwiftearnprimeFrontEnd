  ...
  return (
    <Container>
        ...
        <H1 data-aos="fade-down">About us</H1>
           ...
           Since you are on the About us page, we have to introduce ourselves.<br/>So...Hello, we are a friendly SwiftEarn Prime team.
           <br/>
           <br/>
           <br/>
           ...
           <CertHold>
            <H11>SwiftEarn Prime RC: 11490018</H11>
...
width: 100%;
background: linear-gradient(120deg, #000, #333333);
height: auto;
display: flex;
