...
const Affiliate = () => {
  ...
  return (
    <Container>
        <Wrapper>
            <H1 data-aos="fade-down">SwiftEarn Prime Affiliate program is more  <span style={{color: "#D77600"}}>profitable</span> with friends.</H1>
            <Advice>
                <Cont>
            ...
            <Bottom>
                ...
                <br/>
                <br/>
                The number of partners involved, as well as the partner’s profit, has no limits. At the same time, the conditions of the current affiliate program can be changed in the future at the initiative of SwiftEarn Prime.
                </Content>
                </Hold>
            </Bottom>
            <Notice>
...
align-items: center;
padding: 20px 0;
border-bottom: 3px solid #D77600;
`;
