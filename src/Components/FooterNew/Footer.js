...
const Footer = () => {
  ...
  return (
    <Container>
        <H1>SwiftEarn Prime</H1>
        <Line3>
            <Col1>
                <span style={{fontWeight: "bold", fontSize: "20px", marginBottom: "10px", color: "#D77600"}}>Market</span>
            ...
            <Col1>
            <span style={{fontWeight: "bold", fontSize: "20px", marginBottom: "10px", color: "#D77600"}}>Useful Links</span>
                <a href="/">Home</a> 
            ...
            <Col2>
            <span style={{fontWeight: "bold", fontSize: "20px", marginBottom: "10px", color: "#D77600"}}>Help Center</span>
            ...
            <span style={{fontWeight: "bold", fontSize: "20px", marginBottom: "10px", color: "#D77600"}}>Contact Information</span>
                ...
                <div>SwiftEarn Prime<br/>@gmail.com</div>
                <br/>
                <a href="/support">SwiftEarn Prime.org</a>
