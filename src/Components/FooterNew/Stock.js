...
const Stock = () =>{
    return(
        <Container>
            ...
            <Hold2>
                <Div>
                    ...
                    <Holder>
                        <Icon />
                        <Pagename>--What is Stock</Pagename>
                    </Holder>
                </Div>
            </Hold2>
        </Wrapper>
        ...
        <br/>
        <br/>
        While stocks fluctuate, growth may help you keep ahead of inflation. Potentially generate income with dividends. 
        <span style={{color: "#D77600"}}>Flexibility for long- and short-term investing strategies.</span> Placing a stock trade is about a lot more than pushing a button and entering your order. This brief video can help you prepare before you open a position and develop a plan for managing it.
        <br/>
        <br/>
